...
param (
    ...
    #[URI]$DASH = 'file://D:\vantage_store\e5543806-92d6-4048-b6f2-904e1e387d3f\sourcempeg2_422_pro_ntsc\sourcempeg2_422_pro_ntsc.m3u8',
    #[URI]$DASH = 'file://d:\everyday\20180115\chromecast\ezr.m3u8',
    [URI]$DASH = 'file://d:\everyday\20180121\chromecast\ezr.m3u8',
    #[URI]$DASH,
    [string]$ChromecastIpAddr= '192.168.1.8',
    [string]$wwwRoot ='c:\test',
    [string]$httpServerAddr = '192.168.1.6',
    #[string]$httpServerAddr = 'commondatastorage.googleapis.com',
    [string]$httpServerPort = '8000'
    #[string]$httpServerPort = '80'
)
...
#
# for test
#$shortName = 'gtv-videos-bucket/sample/BigBuckBunny.mp4'
...
elseif($extName -eq '.mpd')
{
    $codec = "application/dash+xml"
}
elseif($extName -eq '.m3u8')
{
...
$data = '{"type":"LOAD","requestId":46479002,"sessionId":"' + $sessionId + '","media":{"contentId":"http://' + $httpServerAddr + ':' + $httpServerPort + '/' + $shortName + '","streamType":"buffered","contentType":"' + $codec + '","metadata":[{"metadataType":0}]},"autoplay":true,"currentTime":0,"customData":{"payload":{"title:":"test_file","thumb":"images/BigBuckBunny.jpg"}}}'
